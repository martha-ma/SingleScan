...
(
    ...
    localparam PAD8 = log2ceil(64'h82140 - 64'h82120); 
    localparam PAD9 = log2ceil(64'h82150 - 64'h82140); 
    localparam PAD10 = log2ceil(64'h82160 - 64'h82150); 
    localparam PAD11 = log2ceil(64'h82170 - 64'h82160); 
    localparam PAD12 = log2ceil(64'h82180 - 64'h82170); 
    localparam PAD13 = log2ceil(64'h82190 - 64'h82180); 
    localparam PAD14 = log2ceil(64'h821a0 - 64'h82190); 
    localparam PAD15 = log2ceil(64'h821b0 - 64'h821a0); 
    localparam PAD16 = log2ceil(64'h821c0 - 64'h821b0); 
    localparam PAD17 = log2ceil(64'h821d8 - 64'h821d0); 
    localparam PAD18 = log2ceil(64'h821e0 - 64'h821d8); 
    localparam PAD19 = log2ceil(64'h821e8 - 64'h821e0); 
    localparam PAD20 = log2ceil(64'h821f0 - 64'h821e8); 
    localparam PAD21 = log2ceil(64'h821f8 - 64'h821f0); 
    localparam PAD22 = log2ceil(64'h82200 - 64'h821f8); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h82200;
    ...
    // ( 0x82140 .. 0x82150 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 20'h82140   ) begin
            src_channel = 23'b01000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x82150 .. 0x82160 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 20'h82150   ) begin
            src_channel = 23'b00010000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 17;
    end

    // ( 0x82160 .. 0x82170 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 20'h82160   ) begin
            src_channel = 23'b00001000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x82170 .. 0x82180 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 20'h82170   ) begin
            src_channel = 23'b00000100000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x82180 .. 0x82190 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 20'h82180   ) begin
            src_channel = 23'b00000010000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x82190 .. 0x821a0 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 20'h82190   ) begin
            src_channel = 23'b00000000100000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 19;
    end

    // ( 0x821a0 .. 0x821b0 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 20'h821a0   ) begin
            src_channel = 23'b00000000010000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 20;
    end

    // ( 0x821b0 .. 0x821c0 )
    if ( {address[RG:PAD16],{PAD16{1'b0}}} == 20'h821b0   ) begin
            src_channel = 23'b00000000001000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 21;
    end

    // ( 0x821d0 .. 0x821d8 )
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 20'h821d0  && read_transaction  ) begin
            src_channel = 23'b00000000000100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x821d8 .. 0x821e0 )
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 20'h821d8  && read_transaction  ) begin
            src_channel = 23'b00000000000010000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 14;
    end

    // ( 0x821e0 .. 0x821e8 )
    if ( {address[RG:PAD19],{PAD19{1'b0}}} == 20'h821e0  && write_transaction  ) begin
            src_channel = 23'b00000000000000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 16;
    end

    // ( 0x821e8 .. 0x821f0 )
    if ( {address[RG:PAD20],{PAD20{1'b0}}} == 20'h821e8  && write_transaction  ) begin
            src_channel = 23'b00000000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
    end

    // ( 0x821f0 .. 0x821f8 )
    if ( {address[RG:PAD21],{PAD21{1'b0}}} == 20'h821f0  && read_transaction  ) begin
            src_channel = 23'b00000000000000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 18;
    end

    // ( 0x821f8 .. 0x82200 )
    if ( {address[RG:PAD22],{PAD22{1'b0}}} == 20'h821f8   ) begin
