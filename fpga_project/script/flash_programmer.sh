...
#
nios2-flash-programmer "../flash/SingleScan_epcs_flash.flash" --base=0x81000 --epcs --sidp=0x821F0 --id=0x12345 --timestamp=1568185995 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program --verbose 
...
#
nios2-flash-programmer "../flash/scan_epcs_flash.flash" --base=0x81000 --epcs --sidp=0x821F0 --id=0x12345 --timestamp=1568185995 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program --verbose 
