...
set_location_assignment PIN_B6 -to LED1
set_location_assignment PIN_C6 -to LED2

set_location_assignment PIN_AA20 -to readhead_sig
...
set_location_assignment PIN_Y4 -to alarm_io[0]
set_location_assignment PIN_AA4 -to alarm_io[1]
set_location_assignment PIN_AA6 -to alarm_io[2]
set_location_assignment PIN_AB6 -to alarm_io3

set_location_assignment PIN_U22 -to alarm_select_io[0]
set_location_assignment PIN_V22 -to alarm_select_io[1]
set_location_assignment PIN_W22 -to alarm_select_io[2]
set_location_assignment PIN_Y22 -to alarm_select_io[3]
...
set_location_assignment PIN_G22 -to HEN
